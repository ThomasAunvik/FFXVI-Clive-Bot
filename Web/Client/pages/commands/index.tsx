    ...
    return (
      <>
        <Head>
          ...
          <meta name="description" content="A List of Commands for the Clive Bot" />
        </Head>
        <main>
            <MainPageNavBar
                ...
                <Table>
                    ...
                    <tbody>
                        ...
                        <tr onClick={collapseClick} className={styles.tablerow}>
                            ...
                            <td>{command.permissions.map(p => p.name).join(", ")}</td>
                        </tr>
                        <tr className="collapse" key={"command-collapse-" + command.command}>
                            <td colSpan={3}>
                                <Table>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr key={"command-" + command.command + "-arg-" + arg.parameter}>
                                            <td>{arg.parameter}</td>
