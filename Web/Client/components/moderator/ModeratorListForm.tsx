import { faPencil, faSave, faSpinner, faTrash } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import axios from "axios";
import { Formik } from "formik";
import { useState } from "react";
import { Button, ButtonGroup, Collapse, Form, ListGroup, ListGroupItem, Spinner } from "react-bootstrap";
...
export const ModeratorListForm = (
	props: IModeratorListFormProps 
) => {
	const { 
		moderator,
		onDelete,
	...
	>{({
		...
		>
			<ButtonGroup className="mb-3">
				...
				>
					<FontAwesomeIcon icon={faPencil} width={20} style={{display: "block"}} />
				</Button>
				<Button
					variant="success"
					type="submit"
