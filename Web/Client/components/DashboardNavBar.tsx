...
const NavEntry = ({ entry }: { entry: NavigationEntry }) => {
  const text = (
    <span className="group flex items-center rounded-lg p-2 text-gray-900 dark:hover:bg-gray-700 hover:bg-gray-100 dark:text-white">
      <span className="h-5 w-5 text-gray-500 transition duration-75 dark:group-hover:text-white dark:text-gray-400 group-hover:text-gray-900">
        {entry.icon}
      </span>
            ...
            <div className="flex items-center">
              <div className="ms-3 flex items-center">
                <div>
                  <button
                    type="button"
                    className="flex rounded-full bg-gray-800 text-sm dark:focus:ring-gray-600 focus:ring-4 focus:ring-gray-300"
                    aria-expanded="false"
        ...
        <div id="basic-navbar-nav">
          <div className="me-auto">
            ...
            >
              ...
              <Link
                href="/dashboard/settings/moderator"
                //</div>active={currentPath?.startsWith(
          ...
          <div className="mr-auto">
            <Link href={""}>{username ?? "Loading..."}</Link>
          </div>
          <div className="mr-auto">
